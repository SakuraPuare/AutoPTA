...
class ZhipuChatInit:
    ...
    def __init__(self):
        ZHIPUAI_API_KEY, ZHIPUAI_MODEL = get_conf(
    ...
    def __conversation_user(self, user_input: str, llm_kwargs: dict):
        if self.model not in ["glm-4v"]:
            ...
            input_, encode_img = input_encode_handler(
                user_input, llm_kwargs=llm_kwargs)
            what_i_have_asked = {"role": "user", "content": []}
            what_i_have_asked['content'].append(
